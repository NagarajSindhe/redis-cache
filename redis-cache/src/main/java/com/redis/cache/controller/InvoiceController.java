...
import com.redis.cache.serviceImpl.InvoiceService;
...
public class InvoiceController {
	...
	@GetMapping("getInvoiceByInvoice/{invoice}")
	public List<Invoice> findByInvNameContainingIgnoreCase(@PathVariable("invoice") String name) {
		return invoiceService.findByInvNameContainingIgnoreCase(name);
	}
}
